...
?>
<div class="clr"></div>
<form action="<?php echo JRoute::_('index.php?option=com_nivoslider&view=sliders'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="adminlist">
		...
		foreach ($this->items as $i => $item) :
			...
			$canEditOwn	= true; 
			$canChange	= true;
			$urlEdit = NivoSliderHelper::getUrlItems($item->id);
			...
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td>
					<?php if ($canEdit || $canEditOwn) : ?>
						<a href="<?php echo JRoute::_('index.php?option=com_nivoslider&task=slider.edit&id='.(int) $item->id); ?>">
				...
				<td class="center">
					<?php echo JHtml::link($urlEdit, JText::_('COM_NIVOSLIDER_EDIT_SLIDES'))?>
				</td>
				<td class="center">
